// Test_MXF.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
//-t avid -f 25 --project BACH --clip "BACH001" -o "E:\crash\AvidMediaFiles\BACH001-TEST" --vc3_1080p_1237 "E:\crash\bach-video.dnxhd" --wave "E:\crash\bach-audio.wav"
int main(int argc, const char** argv)
{
	...
	try
	{
		...
		for (i = 0; i < unused_input_tracks.size(); i++) {
			...
			log_info("Input %d is not mapped (essence type '%s')\n",
